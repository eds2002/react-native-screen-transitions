/**
 * CREDITS:
 * https://github.com/enzomanuelmangano/demos/blob/main/src/animations/composable-text/composable-text.tsx
 */
	...
	({ text, style, containerStyle }: ComposableTextProps) => {
		...
		const buildKeys = useMemo(() => {
			...
			return text.split("").map((char, idx) => {
				...
				return `${char}-${count}-${idx}`; // Creates keys like 'a-0-0-0', 'a-1-1-0' for repeated chars
			});
		}, [text]);
