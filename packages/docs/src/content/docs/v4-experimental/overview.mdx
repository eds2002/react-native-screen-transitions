...
If you prefer a runnable reference, use the [Expo Router starter](https://github.com/eds2002/react-native-screen-transitions/tree/main/starters/expo-router) or [React Navigation starter](https://github.com/eds2002/react-native-screen-transitions/tree/main/starters/react-navigation).
