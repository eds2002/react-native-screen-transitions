...
<table className="mt-4 w-full max-w-[46rem] table-fixed border-separate border-spacing-0 overflow-hidden rounded-3xl border border-black/10 text-left text-sm dark:border-white/14">
  ...
  <tbody>
    <tr>
      <td className="px-4 py-3 text-neutral-600 dark:text-neutral-400"><code>React.ComponentType&lt;any&gt; | ScreenBackdropComponent</code></td>
      <td className="px-4 py-3 text-neutral-600 dark:text-neutral-400"><code>undefined</code></td>
      <td className="px-4 py-3 text-neutral-600 dark:text-neutral-400">No</td>
    </tr>
  </tbody>
...
<table className="mt-4 w-full max-w-[46rem] table-fixed border-separate border-spacing-0 overflow-hidden rounded-3xl border border-black/10 text-left text-sm dark:border-white/14">
  ...
  <tbody>
    <tr>
      <td className="px-4 py-3 text-neutral-600 dark:text-neutral-400"><code>React.ComponentType&lt;any&gt; | ScreenContentComponent</code></td>
      <td className="px-4 py-3 text-neutral-600 dark:text-neutral-400"><code>undefined</code></td>
      <td className="px-4 py-3 text-neutral-600 dark:text-neutral-400">No</td>
    </tr>
  </tbody>
...
Custom renderer for the visual surface inside the content layer. It receives the `surface` slot's animated styles, animated props, pointer events, and screen children. Shared-element fallback content remains outside this component.
...
<table className="mt-4 w-full max-w-[46rem] table-fixed border-separate border-spacing-0 overflow-hidden rounded-3xl border border-black/10 text-left text-sm dark:border-white/14">
  ...
  <tbody>
    <tr>
      <td className="px-4 py-3 text-neutral-600 dark:text-neutral-400"><code>React.ComponentType&lt;any&gt; | ScreenSurfaceComponent</code></td>
      <td className="px-4 py-3 text-neutral-600 dark:text-neutral-400"><code>undefined</code></td>
      <td className="px-4 py-3 text-neutral-600 dark:text-neutral-400">No</td>
    </tr>
  </tbody>
