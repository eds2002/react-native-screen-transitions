...
summary: "v3.9 makes bounds measurement more deterministic, improves retargeting, and introduces the simplified Boundary API."
description: "v3.9 makes bounds measurement more deterministic, improves retargeting, and introduces the simplified Boundary API."
eyebrow: "Changelogs"
group: "Changelogs"
hidden: true
