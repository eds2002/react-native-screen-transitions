...
export const CONTAINER_REVEAL_BORDER_RADIUS = Platform.select({
	ios: 58,
	android: 36,
	default: 36,
});
export const CONTAINER_REVEAL_SHADOW_COLOR = "rgba(0, 0, 0, 0.34)";
export const CONTAINER_REVEAL_SHADOW_RADIUS = 34;
export const CONTAINER_REVEAL_SHADOW_OFFSET_Y = 18;
