...
export default function BlankStackDeepLink() {
	...
	return (
		<SafeAreaView style={styles.container} edges={["top"]}>
			<ScreenHeader title="Blank Stack Deep Link" subtitle={`id: ${id}`} />
			<View style={styles.content}>
				<Text style={styles.label}>Stack Type</Text>
				<Text style={styles.value}>Blank Stack</Text>
				...
				<View style={styles.buttons}>
					...
					<Pressable
						...
						style={styles.button}
						onPress={() =>
							router.push("/blank-stack/deep-link/beta" as `/blank-stack/${string}`)
						}
					>
