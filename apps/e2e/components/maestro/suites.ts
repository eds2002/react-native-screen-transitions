...
export const MAESTRO_SUITES = [
	{
		id: "navigation-and-dismissal",
		title: "Navigation And Dismissal",
		description: "Push, nested push, back, and repeated route-level dismissal.",
		cases: [
	...
	},
	{
		...
		description: "Pinch-driven dismiss behavior.",
		cases: [
	...
	},
	{
		...
		description: "Bottom and horizontal-origin sheet coverage.",
		cases: [
	...
	},
	{
		id: "auto-snap",
		title: "Auto Snap",
		description: "Measured-content snap point behavior.",
		cases: [
	...
	{
		id: "programmatic-snap-actions",
		title: "Programmatic Snap Actions",
		description: "snapTo state changes through visible actions.",
		cases: [
	...
	},
	{
		id: "snap-lock",
		title: "Snap Lock",
		description: "Locked user gestures with programmatic escape hatches.",
		cases: [
	...
	},
	{
		...
		description: "Expected snap result when multiple axes are configured.",
		cases: [
	...
	},
	{
		...
		description: "ScrollView boundary behavior and sheet gesture takeover.",
		cases: [
	...
	},
	{
		...
		description: "Dismiss, collapse, block, passthrough, and custom backdrops.",
		cases: [
	...
	},
	{
		...
		title: "SmoothClip v4",
		description:
			"Public clip hosts, mixed slots, boundary handoff, interruption, and relayout.",
		cases: [
...
export const MAESTRO_CASE_COUNT = MAESTRO_SUITES.reduce(
	(total, suite) => total + suite.cases.length,
	0,
);

export function getMaestroSuite(id: string): MaestroSuite | undefined {
	return MAESTRO_SUITES.find((suite) => suite.id === id);
}
