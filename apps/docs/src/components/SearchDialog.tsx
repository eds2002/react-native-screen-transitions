...
const DOC_PAGES: DocPage[] = [
	...
	{ title: "Presets", path: "/docs/presets", section: "Concepts" },
	{
	...
	{ title: "Recipes", path: "/docs/recipes", section: "Guides" },
	{ title: "Migration", path: "/docs/migration", section: "Guides" },
	{ title: "Release Notes", path: "/docs/release-notes", section: "Release" },
	{
		title: "3.3 Stable",
		path: "/docs/release-notes/3-3-stable",
		section: "Release",
	},
	{
		title: "3.4 Next",
		path: "/docs/release-notes/3-4-next",
		section: "Release",
	},
