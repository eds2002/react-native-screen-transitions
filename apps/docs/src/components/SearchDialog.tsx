...
const DOC_PAGES: DocPage[] = [
	...
	{ title: "Presets", path: "/docs/presets", section: "Animation" },
	{
	...
	{
		title: "bounds(...) Helper",
		path: "/docs/bounds-helper",
		section: "Bounds",
	},
	{
		title: "Navigation Zoom",
		path: "/docs/navigation-zoom",
		section: "Bounds",
	},
	{
		title: "Gestures",
	...
	{ title: "Common Recipes", path: "/docs/recipes", section: "Patterns" },
	{
		...
		path: "/docs/gesture-ownership",
		section: "Gestures",
	},
	{
		title: "Scroll Handoff",
		path: "/docs/scroll-handoff",
		section: "Gestures",
	},
	{
		title: "Snap Points & Sheets",
		path: "/docs/snap-points-sheets",
		section: "Gestures",
	},
