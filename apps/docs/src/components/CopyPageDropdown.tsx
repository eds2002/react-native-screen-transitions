...
export default function CopyPageDropdown() {
	...
	return (
		<div className="relative inline-flex items-center" ref={dropdownRef}>
			{/* Main copy button + chevron wrapper */}
			<div className="inline-flex items-center overflow-hidden rounded-3xl bg-zinc-100 dark:bg-zinc-900 max-h-8">
				<button
					type="button"
					className="inline-flex items-center gap-2 border-0 bg-transparent px-3 py-1.5 text-sm font-medium text-zinc-700 whitespace-nowrap transition-colors cursor-pointer hover:bg-zinc-200/60 dark:text-zinc-300 dark:hover:bg-zinc-700/60"
				...
				<button
					type="button"
					className="inline-flex items-center justify-center border-y-0 border-r-0 border-l border-solid border-zinc-200 bg-transparent px-2 py-3 text-zinc-400 transition-colors cursor-pointer hover:bg-zinc-200/60 hover:text-zinc-700 dark:border-zinc-800 dark:hover:bg-zinc-700/60 dark:hover:text-zinc-300"
			...
			{/* Dropdown menu */}
			{isOpen && (
			<div className="absolute right-0 top-full z-50 w-52 overflow-hidden rounded-2xl border-zinc-100 bg-zinc-100 dark:bg-zinc-900 mt-2 p-1">
				<button
					type="button"
					className="flex w-full items-center gap-2.5 border-0 bg-transparent px-3 py-2 text-left text-sm text-zinc-700 transition-colors duration-150 cursor-pointer hover:bg-zinc-200 dark:text-zinc-300 dark:hover:bg-zinc-700 rounded-xl"
					onClick={handleCopyMarkdown}
				>
					<svg
						className="h-4 w-4 shrink-0 text-zinc-400 transition-colors duration-150 group-hover:text-zinc-600 dark:group-hover:text-zinc-200"
						viewBox="0 0 24 24"
						fill="none"
						stroke="currentColor"
						strokeWidth="2"
