...
Use the first group to decide **when a gesture can start**. Use the velocity settings to tune **how decisive the release feels** once a gesture is already active.
