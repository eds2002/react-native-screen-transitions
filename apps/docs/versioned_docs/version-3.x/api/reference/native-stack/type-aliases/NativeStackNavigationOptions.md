...
[Documentation](../../README.md) / [native-stack](../README.md) / NativeStackNavigationOptions

# Type Alias: NativeStackNavigationOptions

> **NativeStackNavigationOptions** = `NativeStackScreenTransitionConfig` & `object`

Defined in: native-stack/types.ts:158
...
> `optional` **animationMatchesGesture**: `boolean`
...
> `optional` **fullScreenGestureShadowEnabled**: `boolean`
...
> `optional` **header**: (`props`) => `React.ReactNode`
...
[`NativeStackHeaderProps`](NativeStackHeaderProps.md)
...
> `optional` **headerBackButtonDisplayMode**: `ScreenStackHeaderConfigProps`\[`"backButtonDisplayMode"`\]
...
> `optional` **headerBackground**: () => `React.ReactNode`
...
> `optional` **headerBackTitleStyle**: `StyleProp`\<\{ `fontFamily?`: `string`; `fontSize?`: `number`; \}\>
...
> `optional` **headerLargeStyle**: `StyleProp`\<\{ `backgroundColor?`: `string`; \}\>
...
> `optional` **headerLargeTitleStyle**: `StyleProp`\<\{ `color?`: `string`; `fontFamily?`: `string`; `fontSize?`: `number`; `fontWeight?`: `string`; \}\>
...
> `optional` **headerLeft**: (`props`) => `React.ReactNode`
...
[`NativeStackHeaderLeftProps`](NativeStackHeaderLeftProps.md)
...
> `optional` **headerRight**: (`props`) => `React.ReactNode`
...
[`NativeStackHeaderRightProps`](NativeStackHeaderRightProps.md)
...
> `optional` **headerStyle**: `StyleProp`\<\{ `backgroundColor?`: `string`; \}\>
...
> `optional` **headerTitle**: `string` \| (`props`) => `React.ReactNode`
...
> `optional` **headerTitleStyle**: `StyleProp`\<`Pick`\<`TextStyle`, `"fontFamily"` \| `"fontSize"` \| `"fontWeight"`\> & `object`\>
...
> `optional` **keyboardHandlingEnabled**: `boolean`
...
> `optional` **nativeGestureDirection**: `ScreenProps`\[`"swipeDirection"`\]
...
> `optional` **nativeGestureEnabled**: `boolean`
...
> `optional` **nativeGestureResponseDistance**: `ScreenProps`\[`"gestureResponseDistance"`\]
...
> `optional` **navigationBarTranslucent**: `boolean`
...
> `optional` **sheetAllowedDetents**: `number`[] \| `"fitToContents"`
...
> `optional` **sheetCornerRadius**: `number`
...
> `optional` **sheetElevation**: `number`
...
> `optional` **sheetExpandsWhenScrolledToEdge**: `boolean`
...
> `optional` **sheetGrabberVisible**: `boolean`
...
> `optional` **sheetInitialDetentIndex**: `number` \| `"last"`
...
> `optional` **sheetLargestUndimmedDetentIndex**: `number` \| `"none"` \| `"last"`
...
> `optional` **statusBarBackgroundColor**: `string`
...
### unstable\_sheetFooter()?

> `optional` **unstable\_sheetFooter**: () => `React.ReactNode`
